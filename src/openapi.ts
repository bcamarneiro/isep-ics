  ...
  paths: {
    ...
    '/calendar.ics': {
      get: {
        ...
        description: 'Retrieve the ISEP timetable as an iCalendar (.ics) feed that can be imported into calendar applications',
        responses: {
          '200': {
    ...
    '/healthz': {
      get: {
        ...
        description: 'Check the health status of the service including cache status and session validity',
        responses: {
          '200': {
